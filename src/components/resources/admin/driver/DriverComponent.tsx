      ...
      <div className="mt-3 md:flex md:items-center md:justify-between">
        ...
        <div className="relative mt-4 flex items-center md:mt-0">
          ...
          <input
            ...
            type="text"
            placeholder="Search"
            className="block w-full rounded-sm border border-gray-200 bg-white py-1.5 pl-11 pr-5 text-gray-700 placeholder-gray-400/70 focus:border-primary focus:outline-none focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-blue-300 md:w-80 rtl:pl-5 rtl:pr-11"
          />
        </div>
      </div>
